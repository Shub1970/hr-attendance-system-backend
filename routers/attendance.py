...
@router.get("", response_model=list[AttendanceOut], summary="List attendance")
def list_attendance(
...
@router.get("/{attendance_id}", response_model=AttendanceOut, summary="Get attendance by UUID")
...
@router.put("/{attendance_id}", response_model=AttendanceOut, summary="Update attendance")
